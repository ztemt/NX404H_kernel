...
#define IMX135_SENSOR_NAME "imx135_flash2"
DEFINE_MSM_MUTEX(imx135_flash2_mut);
...
static const struct of_device_id imx135_dt_match[] = {
	{.compatible = "qcom,imx135_flash2", .data = &imx135_s_ctrl},
	{}
};
...
static int __init imx135_flash2_init_module(void)
{
	int32_t rc = 0;
	pr_info("%s:%d\n", __func__, __LINE__);
...
static void __exit imx135_flash2_exit_module(void)
{
	pr_info("%s:%d\n", __func__, __LINE__);
...
static struct msm_sensor_ctrl_t imx135_s_ctrl = {
	...
	.msm_sensor_mutex = &imx135_flash2_mut,
	.sensor_v4l2_subdev_info = imx135_subdev_info,
	.sensor_v4l2_subdev_info_size = ARRAY_SIZE(imx135_subdev_info),
};

module_init(imx135_flash2_init_module);
module_exit(imx135_flash2_exit_module);
MODULE_DESCRIPTION("imx135_flash2");
