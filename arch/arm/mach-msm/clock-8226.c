...
//--- add by duguowei,2013.12.18,for breath led
  ...
  CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6b.qcom,camera"), 
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "21.qcom,camera"), ///add for imx135_flash2
	...
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "21.qcom,camera"),    ///add for imx135_flash2
	...
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "68.qcom,eeprom"),
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "68.qcom,eeprom"),
